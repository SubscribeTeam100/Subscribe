...
function billingAgreement() {
    ...
    var ret = {
        ...
        execute: function execute(token, data, config, cb) {
            ...
            api.executeHttp('POST', baseURL + token + '/agreement-execute', data, config, cb);
        },
        /**
        ...
        suspend: function suspend(id, data, config, cb) {
            api.executeHttp('POST', baseURL + id + '/suspend', data, config, cb);
        },
        /**
        ...
        reactivate: function reactivate(id, data, config, cb) {
            api.executeHttp('POST', baseURL + id + '/re-activate', data, config, cb);
        },
